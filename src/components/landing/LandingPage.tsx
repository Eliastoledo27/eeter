...
const metrics = [
    ...
    { icon: ShieldCheck, value: 'Premium', label: 'Seleccion', sub: 'Curaduria ETER' },
];
...
const testimonials = [
    ...
    },
    {
        ...
        quote: 'La velocidad es todo. Meto 2 o 3 ventas por dia y me quedo tranquilo porque el producto llega como se promete. Mis clientes vuelven por la atencion y el estilo.',
        win: '$620k',
        orders: '52',
        rating: '5.0',
...
function Hero() {
    return (
        <section className="relative z-0 overflow-hidden bg-[#050505] pt-28">
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_44%_32%,rgba(57,255,20,.15),transparent_35%),radial-gradient(circle_at_82%_44%,rgba(160,32,240,.16),transparent_35%),radial-gradient(circle_at_20%_80%,rgba(0,224,255,.12),transparent_30%)]" />
            <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(255,255,255,.035)_1px,transparent_1px),linear-gradient(rgba(255,255,255,.03)_1px,transparent_1px)] bg-[size:52px_52px] opacity-35" />
            ...
            <motion.div 
                ...
                className="absolute -left-[10%] -top-[10%] hidden h-[60%] w-[60%] bg-gradient-to-br from-[#39FF14]/10 to-transparent blur-[60px]"
            />
            ...
            <motion.div 
                ...
                className="absolute -bottom-[10%] -right-[10%] hidden h-[50%] w-[50%] bg-gradient-to-tr from-[#A020F0]/10 to-transparent blur-[50px]"
            />
            ...
            <div className="mx-auto grid min-h-[690px] max-w-[1440px] grid-cols-1 items-center gap-8 px-5 pb-8 md:px-10 lg:grid-cols-[.9fr_1.1fr]">
                <motion.div initial="hidden" animate="visible" variants={stagger} className="relative z-10 max-w-[610px] pt-8">
                    ...
                    <motion.div variants={fadeUp} transition={{ duration: 0.75, ease: easeOut }} className="mb-6 flex items-center gap-3">
                        <span className="h-3 w-3 rounded-full bg-[#00E0FF] shadow-[0_0_12px_#00E0FF] animate-pulse" />
                    ...
                    <motion.p variants={fadeUp} transition={{ duration: 0.75, ease: easeOut }} className="mb-5 text-4xl font-black uppercase leading-none tracking-[-0.04em] sm:text-5xl mt-4">
                        <span className="text-[#39FF14]">Sin stock.</span> <br className="sm:hidden" /><span className="text-[#00E0FF]">Sin límites.</span> <br className="sm:hidden" /><span className="text-[#A020F0]">Riesgo cero.</span>
                    </motion.p>
                    <motion.p variants={fadeUp} transition={{ duration: 0.75, ease: easeOut }} className="mb-7 flex items-center gap-3 text-sm font-bold uppercase tracking-[0.05em] text-white">
                        ...
                        <span><span className="text-[#00E0FF]">+500</span> revendedores activos en Argentina</span>
                    </motion.p>
                ...
                <motion.div initial={{ opacity: 0, x: 60, scale: 0.96 }} animate={{ opacity: 1, x: 0, scale: 1 }} transition={{ duration: 1.05, ease: easeOut, delay: 0.2 }} className="relative z-10 min-h-[380px] lg:min-h-[620px]">
                    ...
                    <motion.div 
                        ...
                        className="absolute -top-10 -right-20 w-40 h-40 bg-gradient-to-br from-[#00E0FF]/20 to-transparent blur-[30px] rounded-full hidden lg:block" 
                    />
                    <motion.div 
                        animate={{ y: [0, 15, 0], x: [0, -10, 0], scale: [1.05, 0.95, 1.05] }} 
                        transition={{ duration: 14, repeat: Infinity, ease: "easeInOut", delay: 1 }}
                        
                        className="absolute -bottom-20 -left-10 w-56 h-56 bg-gradient-to-tr from-[#A020F0]/15 to-transparent blur-[40px] rounded-full hidden lg:block" 
                    />
                    <div className="absolute bottom-12 left-4 right-0 mx-auto h-[120px] max-w-[700px] bg-[#00E0FF]/10 blur-3xl" />
            ...
            <div className="eter-card mx-auto grid max-w-[1440px] grid-cols-2 overflow-hidden lg:grid-cols-4">
                {metrics.map(({ icon: Icon, value, label, sub }, index) => (
                    ...
                    >
                        ...
                        <Icon className={`h-9 w-9 shrink-0 ${index === 0 ? 'text-[#00E0FF]' : index === 1 ? 'text-[#39FF14]' : index === 2 ? 'text-[#A020F0]' : 'text-[#00E0FF]'}`} strokeWidth={1.8} />
                        <div>
...
function ProductSection({ products, onPreview }: { products: Product[]; onPreview: (p: Product) => void }) {
        ...
        <section className="relative z-0 bg-[#050505] px-5 py-6 md:px-10" >
            ...
            >
                <motion.div variants={fadeUp} transition={{ duration: 0.65, ease: easeOut }} className="mb-3 flex items-center justify-between gap-4">
                    ...
                    <Link href="/catalog" className="eter-outline-cta hidden h-10 items-center gap-3 px-6 text-[10px] md:inline-flex hover:border-[#00E0FF] hover:text-[#00E0FF] hover:bg-[#00E0FF]/5 transition-all">
                        Ver colección completa <ArrowRight size={14} className="text-[#39FF14] group-hover:text-[#39FF14]" />
                    </Link>
                </motion.div>
                    ...
                    {visibleProducts.map((product, index) => (
                        ...
                        >
                            <div
                                ...
                                aria-label={`Ver detalles rápidos de ${product.name}`}
                                className="product-card group relative block min-w-[175px] snap-start overflow-hidden p-3 bg-[#080808]/40 border border-white/5 hover:border-[#00E0FF]/20 hover:shadow-[0_12px_30px_rgba(0,229,255,0.05)] rounded-2xl cursor-pointer select-none transition-all duration-300 focus-visible:ring-2 focus-visible:ring-[#00E0FF] focus-visible:outline-none"
                            >
                                <span className="brush-stroke brush-green right-2 top-2 h-4 w-16 opacity-70" />
                                <span className={`absolute left-3 top-3 z-10 rounded-sm px-2 py-1 text-[10px] font-black uppercase text-black ${index % 3 === 0 ? 'bg-[#39FF14] shadow-[0_0_10px_#39FF14]' : index % 3 === 1 ? 'bg-[#00E0FF] shadow-[0_0_10px_#00E0FF]' : 'bg-[#A020F0] text-white shadow-[0_0_10px_#A020F0]'}`}>
                                    {index % 2 === 0 ? 'Hot' : 'New'}
                                </span>
                                <div className="relative mb-3 aspect-square overflow-hidden rounded-md bg-[#0c0c0c] border border-white/[0.03]">
                                    <FadeInImage
                                    ...
                                    <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center pointer-events-none">
                                        <span className="text-[9px] font-black uppercase tracking-[0.15em] px-3 py-1.5 bg-[#00E0FF] text-black rounded-lg shadow-lg shadow-[#00E0FF]/20 transform translate-y-2 group-hover:translate-y-0 transition-transform duration-300">
                                            Detalle Rápido
                                        </span>
                                    </div>
                                </div>
                                <div className="flex items-end justify-between gap-3">
                                    <div>
                                        <h3 className="line-clamp-1 text-[11px] font-black uppercase text-white group-hover:text-[#00E0FF] transition-colors">{product.name}</h3>
                                        <p className="mt-1 text-[10px] uppercase text-white/40">Talles disponibles</p>
                                    </div>
                                    <span className="text-sm font-black text-[#00E0FF] font-mono">${product.basePrice.toLocaleString('es-AR')}</span>
                                </div>
                            </div>
                        </motion.div>
                    ))}
    ...
    return (
        <section className="relative z-0 bg-[#050505] px-5 pb-4 md:px-10">
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: '-80px' }} variants={stagger} className="mx-auto max-w-[1440px]">
                <h2 className="mb-3 text-2xl font-black uppercase tracking-[-0.03em] text-white md:text-3xl">¿Por qué <span className="text-[#00E0FF]">ÉTER?</span></h2>
                <div className="eter-card grid overflow-hidden md:grid-cols-4">
                    {benefits.map(({ icon: Icon, title, text }, index) => (
                        <motion.div key={title} variants={fadeUp} transition={{ duration: 0.55, ease: easeOut, delay: index * 0.03 }} whileHover={{ y: -3, backgroundColor: 'rgba(0,229,255,0.035)' }}  className="relative flex items-center gap-5 border-white/10 p-5 md:border-l md:first:border-l-0">
                            ...
                            <Icon className={`h-9 w-9 shrink-0 ${index % 3 === 0 ? 'text-[#00E0FF]' : index % 3 === 1 ? 'text-[#A020F0]' : 'text-[#39FF14]'}`} strokeWidth={1.8} />
                            <div>
        ...
        <section className="relative z-0 bg-[#050505] px-5 py-3 md:px-10">
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: '-80px' }} variants={stagger} className="mx-auto grid max-w-[1440px] gap-4 lg:grid-cols-[1.05fr_1fr_1fr_1fr]">
                <motion.div variants={fadeUp} transition={{ duration: 0.65, ease: easeOut }} whileHover={{ y: -4 }}  className="group eter-card relative overflow-hidden p-7 shadow-[0_0_40px_rgba(122,0,255,0.1)]">
                    ...
                    <div className="relative z-10 mt-7 text-3xl font-black text-[#00E0FF]">+500 <span className="text-xs uppercase tracking-[0.12em] text-white/60">revendedores activos</span></div>
                ...
                {testimonials.map((t, index) => (
                    <motion.article key={t.name} variants={fadeUp} transition={{ duration: 0.6, ease: easeOut, delay: index * 0.04 }} whileHover={{ y: -5, borderColor: 'rgba(198,255,0,0.45)' }}  className="group relative eter-card overflow-hidden p-6">
                        ...
                        <div className="relative z-10 mb-5 flex items-center gap-3">
                            <div className={`relative p-0.5 rounded-full bg-gradient-to-tr ${index % 2 === 0 ? 'from-[#39FF14] to-[#00E0FF]' : 'from-[#A020F0] to-[#00E0FF]'}`}>
                            ...
                            <div>
                                ...
                                <p className={`text-[10px] font-bold ${index % 2 === 0 ? 'text-[#39FF14]' : 'text-[#00E0FF]'}`}>{t.since}</p>
                            </div>
                        </div>
                        ...
                        <div className="relative z-10 mt-6 grid grid-cols-3 gap-3 border-t border-white/5 pt-4">
                            <div><b className={`block text-lg ${index % 2 === 0 ? 'text-[#39FF14]' : 'text-[#00E0FF]'}`}>{t.win}</b><span className="text-[9px] uppercase text-white/45">Ganancia/mes</span></div>
...
function Certified() {
    return (
        <section className="relative z-0 bg-[#050505] px-5 py-6 md:px-10">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: '-80px' }} variants={stagger} className="eter-card relative mx-auto grid max-w-[1440px] gap-5 overflow-hidden p-5 sm:p-6 lg:grid-cols-[.8fr_2fr]">
                <div className="grunge-overlay opacity-30" />
                <motion.div variants={fadeUp} transition={{ duration: 0.65, ease: easeOut }} className="relative z-10 flex items-center gap-4">
                    <div className="relative flex h-20 w-20 shrink-0 items-center justify-center rounded-md bg-black shadow-[0_0_42px_rgba(255,255,255,0.1)] sm:h-28 sm:w-28">
                    ...
                    <div className="min-w-0">
                        <h2 className="text-2xl font-black uppercase leading-none text-white sm:text-3xl">ETER <span className="text-[#39FF14]">Verified</span></h2>
                        <p className="mt-3 max-w-sm text-sm leading-relaxed text-white/65">Controlamos proveedor, estado del par y stock antes de ofrecerlo. Sin prometer categorias que no usamos.</p>
                    </div>
                </motion.div>
                <div className="relative z-10 grid gap-3 sm:grid-cols-3">
                    {[
                        ['01', ShieldCheck, 'Verificación'],
                        ['02', BadgeCheck, 'Revision'],
                        ['03', CheckCircle2, 'Stock seguro'],
                    ].map(([num, Icon, title, text]) => {
                        const StepIcon = Icon as typeof ShieldCheck;
                        return (
                            <motion.div key={num as string} variants={fadeUp} transition={{ duration: 0.45, ease: easeOut }} className="group relative min-h-[132px] rounded-md border border-[#252525] bg-black/40 p-4 backdrop-blur-sm">
                                <span className="brush-stroke brush-cyan -bottom-1 -right-1 h-2 w-10 opacity-0 group-hover:opacity-40 transition-opacity" />
                                <StepIcon className="mb-4 h-7 w-7 text-[#00E0FF]" />
                                ...
                                <p className="mt-2 text-xs leading-snug text-white/55">{(text as string) || 'Control operativo para vender con stock claro y menos friccion.'}</p>
                            </motion.div>
                        );
                    })}
                </div>
        ...
        <section className="relative z-0 bg-[#050505] px-5 py-10 md:px-10">
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: '-80px' }} variants={stagger} className="eter-card relative mx-auto grid max-w-[1440px] gap-6 overflow-hidden p-6 lg:grid-cols-[.9fr_2fr]">
                <motion.div variants={fadeUp} transition={{ duration: 0.65, ease: easeOut }} className="relative z-10">
                    ...
                    <h2 className="mt-2 text-4xl font-black uppercase leading-none text-white">Vender nunca fue <span className="text-[#00E0FF]">tan simple.</span></h2>
                        ...
                        return (
                            <motion.div key={num as string} variants={fadeUp} transition={{ duration: 0.55, ease: easeOut }} whileHover={{ x: 4 }}  className="group flex gap-4">
                                <div className="relative">
                                    <StepIcon className={`mt-1 h-8 w-8 shrink-0 transition-transform group-hover:scale-110 ${num === '01' ? 'text-[#00E0FF]' : num === '02' ? 'text-[#A020F0]' : 'text-[#39FF14]'}`} />
        ...
        <section className="relative z-0 mt-2 overflow-hidden border-y border-[#252525] bg-[#050505] px-5 py-8 md:px-10">
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: '-80px' }} variants={stagger} className="relative z-10 mx-auto grid max-w-[1440px] items-center gap-8 md:grid-cols-[1.15fr_.85fr]">
                <motion.h2 variants={fadeUp} transition={{ duration: 0.7, ease: easeOut }} className="relative text-4xl font-black uppercase leading-none text-white md:text-6xl">
                    ...
                    <span className="relative">Tu primer par puede ser <span className="block text-[#00E0FF] drop-shadow-[0_0_15px_rgba(0,229,255,0.3)]">tu primer negocio.</span></span>
                </motion.h2>
                <motion.div variants={fadeUp} transition={{ duration: 0.65, ease: easeOut }}>
                    <p className="mb-6 text-base leading-relaxed text-white/70">Más de <b className="text-[#00E0FF]">500 revendedores</b> ya están ganando con ÉTER. El próximo podés ser vos.</p>
                    <form className="grid gap-3 sm:grid-cols-[1fr_auto]">
                        <input className="h-14 rounded-md border border-white/10 bg-black/60 px-4 text-white backdrop-blur-md outline-none focus:border-[#00E0FF] focus:ring-1 focus:ring-[#00E0FF]" placeholder="tu@email.com" type="email" />
...
export default function LandingPage({ initialProducts }: LandingPageProps) {
    ...
    return (
        <main 
            className="flex flex-col min-h-screen overflow-x-hidden text-white selection:bg-[#00E0FF] selection:text-black"
        >
            <Navbar />
            <div className="flex-1 flex flex-col">
                <Hero />
                <MetricsBar />
                <ProductSection products={products} onPreview={handlePreview} />
                <div >
                    <Benefits />
                    <Community />
                    <Certified />
            ...
            {/* Quick Interactive Preview Modal (Luxury Dark, Accesible WCAG 2.1) */}
            <QuickPreviewModal 
