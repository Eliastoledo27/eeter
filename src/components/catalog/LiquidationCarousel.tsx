...
export function LiquidationCarousel({ products, onQuickView }: Props) {
    ...
    return (
        <section className="relative overflow-hidden border-y border-white/10 bg-[#050505] py-8">
            ...
            <div className="relative mb-6 overflow-hidden border-y border-white/10 bg-black/30 py-2">
                <div className="flex w-max animate-[eter-marquee_24s_linear_infinite] gap-8 pr-8">
            ...
            <div className="mx-auto max-w-[1440px] px-6">
                ...
                <div className="grid gap-4 md:grid-cols-3">
                    {liquidationItems.map((item, idx) => (
                        <article
                            key={item.id}
                            className="group relative isolate overflow-hidden rounded-2xl border border-white/10 bg-black/40 p-4"
                        >
                            ...
                            <div className="relative flex items-start justify-between gap-4">
                                <div>
                                    ...
                                    <button
                                        onClick={() => onQuickView?.(item.rawProduct)}
                                ...
                                <button
                                    onClick={() => onQuickView?.(item.rawProduct)}
                                    className="relative h-[82px] w-[82px] shrink-0"
                                >
                                    {item.image ? (
