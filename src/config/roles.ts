...
export const ROUTE_PERMISSIONS: Record<string, string> = {
  ...
  '/dashboard/admin-myshop': 'manage_admin_myshop',
...
export const DASHBOARD_MODULES: NavItem[] = [
  ...
  { id: 'admin_myshop', label: 'Ajustes Mi Tienda', icon: Settings, href: '/dashboard/admin-myshop', requiredPermission: 'manage_admin_myshop' },
