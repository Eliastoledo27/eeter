    ...
    return (
        ...
        >
            <div className="flex flex-col items-center justify-center py-20 text-center">
                <Sparkles className="text-[#00E5FF] mb-8 animate-bounce" size={64} />
                ...
                <Link href="/c/catalogorev" className="group">
                    <button className="h-16 px-10 bg-[#00E5FF] text-black font-black rounded-full hover:bg-white transition-all flex items-center gap-4 uppercase">
