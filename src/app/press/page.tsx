            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
                <div className="space-y-12">
                    <div className="p-10 rounded-[2.5rem] border border-white/5 bg-white/[0.02]">
                        <Newspaper className="text-[#00E5FF] mb-6" size={40} />
                        ...
                        <div className="space-y-6">
                            {[
                                ...
                                <div key={i} className="pb-6 border-b border-white/5 last:border-0">
                                    <span className="text-[#00E5FF] text-xs font-mono">{item.date}</span>
                                    <h4 className="text-white font-medium hover:text-[#00E5FF] cursor-pointer transition-colors mt-2">{item.title}</h4>
                                </div>
                            ))}
                        </div>
                    </div>
                ...
                <div className="space-y-8">
                    <div className="p-8 border border-[#00E5FF]/20 rounded-3xl bg-[#00E5FF]/5">
                        <ImageIcon className="text-[#00E5FF] mb-4" size={32} />
                        ...
                        <button className="flex items-center gap-2 text-black bg-[#00E5FF] px-6 py-3 rounded-full font-bold uppercase text-xs hover:bg-[#00B8D9] transition-colors">
