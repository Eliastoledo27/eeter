    ...
    return (
        ...
        >
            <div className="space-y-24">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {[
                        ...
                        <div key={i} className="text-center p-8 border border-white/5 rounded-[2rem] bg-white/[0.02]">
                            <item.icon className="mx-auto text-[#00E5FF] mb-6" size={48} />
                ...
                <div className="max-w-4xl mx-auto p-12 rounded-[3rem] border border-[#00E5FF]/20 bg-gradient-to-br from-[#111] to-black">
