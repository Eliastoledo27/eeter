    ...
    return (
        ...
        >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-20">
                {features.map((f, i) => (
                    <div key={i} className="p-8 rounded-3xl border border-white/5 bg-white/5 hover:border-[#00E5FF]/30 transition-all group">
                        <f.icon className="text-[#00E5FF] mb-6 group-hover:scale-110 transition-transform" size={40} />
            ...
            <div className="prose prose-invert max-w-none">
                <h2 className="text-3xl font-bold mb-8 text-[#00E5FF] uppercase">Tiempos de Entrega</h2>
