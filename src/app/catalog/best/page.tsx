    ...
    return (
        ...
        >
            <div className="flex flex-col items-center justify-center py-20 text-center">
                <Trophy className="text-[#00E5FF] mb-8" size={64} />
                ...
                <Link href="/catalog" className="group">
                    <button className="h-16 px-10 border-2 border-white text-white font-black rounded-full hover:bg-[#00E5FF] hover:border-[#00E5FF] hover:text-black transition-all flex items-center gap-4 uppercase">
                        Explorar Modelos
