        ...
        <main className="min-h-screen bg-[#0A0A0A] text-white selection:bg-[#00E5FF] selection:text-black overflow-x-hidden">
            ...
            <section className="relative pt-60 pb-32 overflow-hidden">
                <div className="absolute inset-0 z-0">
                    <div className="absolute inset-0 bg-radial-gradient from-[#00E5FF]/10 to-transparent blur-3xl opacity-50" />
                ...
                <div className="container relative z-10 px-6 mx-auto">
                    ...
                    >
                        <span className="px-4 py-2 rounded-full border border-[#00E5FF]/30 bg-[#00E5FF]/5 text-[#00E5FF] text-[10px] font-black tracking-[0.3em] uppercase mb-8 inline-block">
                            Ecosistema Éter
                        </span>
                        <h1 className="text-6xl md:text-8xl font-black mb-8 tracking-tighter uppercase leading-none">
                            REDEFINIENDO EL <br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#00E5FF] to-[#00B8D9]">CALZADO DIGITAL</span>
                        </h1>
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
                        {STATS.map((stat, idx) => (
                            <motion.div
                                ...
                                className="flex flex-col items-center text-center p-8 rounded-[2rem] border border-white/5 bg-black/40 hover:border-[#00E5FF]/30 transition-all group"
                            >
                                <stat.icon className="text-[#00E5FF] mb-4 group-hover:scale-110 transition-transform" size={32} />
                        ...
                        >
                            ...
                            <div className="space-y-4">
                                {['Calidad Brasilera Certificada', 'Packaging de Lujo', 'Envío Express a todo el país'].map((item, i) => (
                                    <div key={i} className="flex items-center gap-4 text-sm font-bold uppercase tracking-widest text-[#00E5FF]">
