    ...
    if (loading) return (
        <div className="min-h-[60vh] flex flex-col items-center justify-center gap-4">
            <div className="relative">
                <div className="w-12 h-12 border-2 border-[#00E5FF]/20 rounded-full animate-ping absolute inset-0" />
                ...
                <div className="relative z-10 flex flex-col xl:flex-row gap-12 items-start xl:items-center justify-between">
                    <div className="space-y-4">
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-[#00E5FF] font-mono text-[10px] tracking-[0.5em] uppercase">Digital Storefront</span>
                        </div>
                        <h1 className="text-5xl md:text-7xl font-black tracking-tighter uppercase italic">
                            Mi Tienda <span className="text-white/20">/</span> <span className="text-[#00E5FF]">ÉTER</span>
                        </h1>
                    ...
                    <div className="w-full xl:w-auto min-w-[320px] bg-white/[0.03] backdrop-blur-3xl border border-white/10 rounded-[2.5rem] p-1 shadow-2xl overflow-hidden group">
                        <div className="p-6 space-y-4">
                            ...
                            <div className="bg-black/40 rounded-2xl px-5 py-4 flex items-center justify-between gap-4 border border-white/5 group-hover:border-[#00E5FF]/30 transition-colors">
                                ...
                                <div className="flex items-center gap-1 shrink-0">
                                    <button
                                        onClick={copyLink}
                                        className="w-10 h-10 flex items-center justify-center rounded-xl bg-white/5 hover:bg-[#00E5FF] hover:text-black transition-all"
                                    >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
                ...
                <div className="lg:col-span-4 space-y-8 sticky top-24">
                    <div className="bg-[#0A0A0A] border border-white/5 rounded-[2.5rem] p-8 space-y-10 relative overflow-hidden">
                        <div className="absolute top-0 right-0 w-32 h-32 bg-[#00E5FF]/5 blur-[60px] rounded-full" />

                        <div className="space-y-1">
                            <h3 className="text-xl font-black tracking-tighter uppercase whitespace-pre-line group-hover:text-[#00B8D9] transition-colors">
                                CONFIGURACIÓN <br /><span className="text-[#00E5FF]">ESTRATÉGICA</span>
                            </h3>
                            ...
                            <div className="flex gap-2">
                                <div className="relative flex-1">
                                    ...
                                    <input
                                        ...
                                        className="w-full bg-white/[0.02] border border-white/10 rounded-2xl pl-24 pr-5 py-4 text-sm focus:outline-none focus:border-[#00E5FF]/50 transition-all font-bold text-white placeholder:text-white/10"
                                    />
                                </div>
                                <div className="flex gap-2">
                                    <motion.button
                                        ...
                                        className={cn(
                                            ...
                                            slug ? "hover:border-[#00E5FF]/40 hover:bg-[#00E5FF] hover:text-black cursor-pointer" : "opacity-20 cursor-not-allowed"
                                        )}
                                        title="Copiar enlace"
                                    >
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center gap-2 mb-2">
                                <Share2 size={14} className="text-[#00E5FF]" />
                                <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest">WhatsApp de Ventas</label>
                            </div>
                            <div className="relative">
                                <span className="absolute left-5 top-1/2 -translate-y-1/2 text-[#00E5FF] font-bold text-lg whitespace-nowrap">+54 9</span>
                                <input
                                    type="text"
                                    value={whatsapp}
                                    onChange={(e) => setWhatsapp(e.target.value.replace(/[^0-9]/g, ''))}
                                    placeholder="2235000000"
                                    className="w-full bg-white/[0.02] border border-white/10 rounded-2xl pl-20 pr-5 py-4 text-sm focus:outline-none focus:border-[#00E5FF]/50 transition-all font-bold text-white text-xl placeholder:text-white/10"
                                />
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center gap-2 mb-2">
                                <Percent size={14} className="text-[#00E5FF]" />
                                <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest">Margen de Ganancia Global</label>
                            </div>
                            <div className="relative">
                                <span className="absolute left-5 top-1/2 -translate-y-1/2 text-[#00E5FF] font-bold text-lg">$</span>
                                <input
                                    type="number"
                                    value={markup}
                                    onChange={(e) => setMarkup(Number(e.target.value))}
                                    className="w-full bg-white/[0.02] border border-white/10 rounded-2xl pl-12 pr-5 py-4 text-sm focus:outline-none focus:border-[#00E5FF]/50 transition-all font-bold text-white text-xl"
                                />
                                <span className="absolute right-5 top-1/2 -translate-y-1/2 text-gray-600 font-mono text-[10px] uppercase">ARS / Unidad</span>
                            </div>
                            <div className="p-4 bg-[#00E5FF]/5 rounded-2xl border border-[#00E5FF]/10 space-y-2">
                                <div className="flex items-center gap-2">
                                    <TrendingUp size={14} className="text-[#00E5FF]" />
                                    <span className="text-[9px] font-black text-[#00E5FF] uppercase tracking-widest">Proyección de Impacto</span>
                                </div>
                        ...
                        <motion.button
                            ...
                            disabled={saving}
                            className="w-full bg-[#00E5FF] text-black h-16 rounded-[1.5rem] font-black uppercase text-xs tracking-[0.2em] shadow-[0_0_30px_rgba(200,138,4,0.3)] hover:bg-[#00B8D9] transition-all disabled:opacity-50 flex items-center justify-center gap-3 group"
                        >
                    ...
                    <div className="bg-white/[0.02] border border-white/5 rounded-[2rem] p-6">
                        ...
                        <ul className="space-y-4">
                            <li className="flex gap-3 items-start">
                                <div className="w-5 h-5 rounded-full bg-[#00E5FF]/10 flex items-center justify-center shrink-0">
                ...
                <div className="lg:col-span-8 space-y-8">
                            ...
                            {products.map((product) => (
                                <div key={product.id} className="p-8 hover:bg-white/[0.02] transition-colors group">
                                    <div className="flex flex-col md:flex-row items-center gap-10">
                                        {/* Product Thumbnail */}
                                        <div className="w-32 h-32 relative bg-black border border-white/5 rounded-3xl overflow-hidden shrink-0 group-hover:border-[#00E5FF]/30 transition-colors shadow-2xl p-4">
                                            {product.images?.[0] ? (
                                                <Image
                                        ...
                                        <div className="flex-1 min-w-0 space-y-4">
                                            <div className="space-y-1">
                                                ...
                                                <h4 className="text-xl font-black uppercase tracking-tight text-white group-hover:text-[#00E5FF] transition-colors">
                                                    {product.name}
                                                </h4>
                                            ...
                                            <div className="flex flex-wrap gap-8 items-center">
                                                ...
                                                <div className="space-y-1">
                                                    <span className="text-[9px] text-[#00E5FF] font-black uppercase tracking-widest block">Tu Precio</span>
                                                    <div className="flex items-center gap-2">
                                        ...
                                        <div className="w-full md:w-auto xl:w-[240px] space-y-4">
                                            <div className="relative">
                                                <input
                                                    ...
                                                    className="w-full h-16 bg-black border border-white/10 rounded-2xl px-6 text-lg font-mono font-black focus:outline-none focus:border-[#00E5FF] transition-all text-white shadow-inner"
                                                />
                    ...
                    <div className="bg-[#00E5FF]/10 border border-[#00E5FF]/20 rounded-[2.5rem] p-10 flex flex-col md:flex-row gap-8 items-center justify-between relative overflow-hidden group">
                        <div className="absolute -bottom-10 -right-10 w-40 h-40 bg-[#00E5FF]/20 blur-3xl rounded-full" />
                        <div className="flex gap-6 items-start relative z-10">
                            ...
                            <div className="space-y-2">
                                <h4 className="text-xl font-bold uppercase text-[#00E5FF]">Control de Calidad y Precios</h4>
